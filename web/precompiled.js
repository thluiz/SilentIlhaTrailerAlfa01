...
["animation", "package:animation/animation.dart", , L, {
  ...
  ElementAnimation: {
    ...
    _advance$1: [function(highResTime) {
      var t1, t2, currentTime, t3, left, percentage;
      t1 = {};
      ...
      this.toProperties.forEach$1(0, new L.ElementAnimation__advance_closure(t1, this, left));
      if (left > 0) {
        t1 = window;
        t2 = this.get$_advance();
        C.Window_methods._ensureRequestAnimationFrame$0(t1);
  ...
  ElementAnimation__initializeFromProperties_closure: {
    "^": "Closure:7;this_0,style_1",
    call$2: function(key, value) {
      var cssValue, t1, match, t2, t3, value0, unit, t4;
      ...
      if (t1._doesPropertyNeedUnit$1(key)) {
        ...
        if (match != null) {
          ...
          if (match != null) {
            ...
            t1.currentProperties.$indexSet(0, key, H.Primitives_parseDouble(value0, null));
            t2 = t1.units;
            t2.$indexSet(0, key, t1._doesPropertyNeedUnit$1(key) ? "px" : "");
          } else
            throw H.wrapException("Cannot animate property \"" + H.S(key) + "\", because of its unsupported value \"" + H.S(cssValue) + "\".");
        }
      } else {
  ...
  ElementAnimation__advance_closure: {
    "^": "Closure:11;box_0,this_1,left_2",
    call$2: function(key, value) {
      ...
      if (C.JSArray_methods.contains$1(C.List_scrollTop_scrollLeft, key))
        switch (key) {
          case "scrollTop":
            t1.element.scrollTop = result;
            break;
          case "scrollLeft":
            t1.element.scrollLeft = result;
            break;
        }
      else
...
["dart.core", "dart:core", , P, {
  ...
  Duration: {
    ...
    $ge: function(_, other) {
      return C.JSInt_methods.$ge(this._core$_duration, other.get$_core$_duration());
    },
    $eq: function(_, other) {
      if (other == null)
        return false;
...
["", "silentilhatraileralfa01.dart", , F, {
  "^": "",
  main: [function() {
    var audio = H.interceptedTypeCast(document.querySelector("#audio01"), "$isMediaElement");
    J.addEventListener$2$x(audio, "ended", new F.main_closure(audio, document.querySelector("#divImg0"), document.querySelector("#divImg1"), document.querySelector("#divImg2")));
  }, "call$0", "main$closure", 0, 0, 6],
  main_closure: {
    "^": "Closure:8;audio_0,divImg0_1,divImg1_2,divImg2_3",
    call$1: function($event) {
      var anim0, anim1, anim2, t1;
      anim0 = new L.ElementAnimation(H.fillLiteralMap([], P.LinkedHashMap_LinkedHashMap(null, null, null, null, null)), H.fillLiteralMap([], P.LinkedHashMap_LinkedHashMap(null, null, null, null, null)), H.fillLiteralMap([], P.LinkedHashMap_LinkedHashMap(null, null, null, null, null)), H.fillLiteralMap([], P.LinkedHashMap_LinkedHashMap(null, null, null, null, null)), this.divImg0_1, false, 500, null, null, 0, false, false, C.Easing_9, P.StreamController_StreamController$broadcast(null, null, false, null), P.StreamController_StreamController$broadcast(null, null, false, null));
      anim0.toProperties = H.fillLiteralMap(["opacity", 0], P.LinkedHashMap_LinkedHashMap(null, null, null, null, null));
      anim0._duration = 2000;
      anim1 = new L.ElementAnimation(H.fillLiteralMap([], P.LinkedHashMap_LinkedHashMap(null, null, null, null, null)), H.fillLiteralMap([], P.LinkedHashMap_LinkedHashMap(null, null, null, null, null)), H.fillLiteralMap([], P.LinkedHashMap_LinkedHashMap(null, null, null, null, null)), H.fillLiteralMap([], P.LinkedHashMap_LinkedHashMap(null, null, null, null, null)), this.divImg1_2, false, 500, null, null, 0, false, false, C.Easing_9, P.StreamController_StreamController$broadcast(null, null, false, null), P.StreamController_StreamController$broadcast(null, null, false, null));
      anim1.toProperties = H.fillLiteralMap(["opacity", 1], P.LinkedHashMap_LinkedHashMap(null, null, null, null, null));
      anim1._duration = 2000;
      anim2 = new L.ElementAnimation(H.fillLiteralMap([], P.LinkedHashMap_LinkedHashMap(null, null, null, null, null)), H.fillLiteralMap([], P.LinkedHashMap_LinkedHashMap(null, null, null, null, null)), H.fillLiteralMap([], P.LinkedHashMap_LinkedHashMap(null, null, null, null, null)), H.fillLiteralMap([], P.LinkedHashMap_LinkedHashMap(null, null, null, null, null)), this.divImg2_3, false, 500, null, null, 0, false, false, C.Easing_9, P.StreamController_StreamController$broadcast(null, null, false, null), P.StreamController_StreamController$broadcast(null, null, false, null));
      anim2.toProperties = H.fillLiteralMap(["opacity", 1], P.LinkedHashMap_LinkedHashMap(null, null, null, null, null));
      anim2._duration = 2000;
      t1 = this.audio_0;
      t1.src = "carmina.mp3";
      t1.play();
      anim0.run$0();
      anim1.run$0();
      P.Timer_Timer(P.Duration$(0, 0, 0, 0, 0, 5), anim2.get$run());
    }
  }
},
1],
...
function dart_precompiled($collectedClasses) {
  ...
  function ElementAnimation(toProperties, fromProperties, currentProperties, units, element, _isInitialized, _duration, _startTime, _pausedAt, _pausedFor, _paused, _stopped, easing, _onStepController, _onCompleteController) {
  ...
  function main_closure(audio_0, divImg0_1, divImg1_2, divImg2_3) {
    this.audio_0 = audio_0;
    this.divImg0_1 = divImg0_1;
    this.divImg1_2 = divImg1_2;
    this.divImg2_3 = divImg2_3;
  }
